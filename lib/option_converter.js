...
registerFormat('application/cose; cose-type="cose-encrypt0"', 16)
registerFormat('application/cose; cose-type="cose-mac0"', 17)
registerFormat('application/cose; cose-type="cose-sign1"', 18)
...
registerFormat('application/pkcs7-mime; smime-type=server-generated-key', 280)
registerFormat('application/pkcs7-mime; smime-type=certs-only', 281)
registerFormat('application/pkcs8', 284)
registerFormat('application/csrattrs', 285)
registerFormat('application/pkcs10', 286)
registerFormat('application/pkix-cert', 287)
...
registerFormat('application/vnd.ocf+cbor', 10000)
registerFormat('application/oscore', 10001)
registerFormat('application/javascript', 10002)
registerFormat('application/vnd.oma.lwm2m+tlv', 11542)
registerFormat('application/vnd.oma.lwm2m+json', 11543)
registerFormat('application/vnd.oma.lwm2m+cbor', 11544)
registerFormat('text/css', 20000)
registerFormat('image/svg+xml', 30000)
