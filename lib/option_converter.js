 ...
 *
 * @param {string} name
 * @param {(value: OptionValue) => Buffer} toBinary
 * @param {(value: Buffer) => OptionValue} fromBinary
 */
 ...
 *
 * @param {string} name Media-Type and parameters.
 * @param {number} value The numeric code of the Content-Format.
 */
