...
// CoAP parameters
var p = {
  // seconds   ackRandomFactor: 1.5,   maxRetransmit: 4,   nstart: 1,   defaultLeisure: 5,   probingRate: 1, // byte/seconds // MAX_LATENCY is the maximum time a datagram is expected to take // from the start of its transmission to the completion of its // reception.   maxLatency: 100 // seconds
  ackTimeout: 2
}
