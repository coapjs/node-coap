...
class CoAPServer extends events.EventEmitter {
    /**
     *
     * @param {CoapServerOptions | requestListener} [options]
    ...
    /**
     *
     * @param {number | events.EventEmitter | (err?: Error) => void} [port]
     * @param {string | (err?: Error) => void} [address]
     ...
     * @param {ParsedPacket} packet The packet that was sent from the client.
