...
var ObserveStream = require('./observe_write_stream')
...
CoAPServer.prototype._sendProxied = function (packet, proxyUri, callback) {
  ...
  var port = url.port
  var message = generate(removeProxyOptions(packet))
...
CoAPServer.prototype._handle = function (packet, rsinfo) {
  var sock = this._sock
  var lru = this._lru
  var cached = lru.peek(toKey(rsinfo.address, rsinfo.port, packet, true))
