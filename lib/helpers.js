 ...
 *
 * @typedef Block2
 * @prop {boolean} moreBlock2 Indicates if the `more` flag is set
 * @prop {number} num The block number
 * @prop {number} size The block size
 */
 ...
 *
 * @param {Option[]} options array of object, in form `{name: value}`
 * @param {OptionName} name name of the object wanted to retrive
 * @return {OptionValue | null} `value`, or null
 */
 ...
 *
 * @param {Option[]} options array of object, in form {name: , value}
 * @param {OptionName} name name of the object wanted to remove
 * @returns {boolean} `true` if the option was found and removed
 */
 ...
 * @returns {Block2 | null} Object describing block2 or `null` on failure
 */
 ...
 *
 * @param {Block2} requestedBlock Object containing block2 information
 * @returns {Buffer} Buffer carrying block2 value
 */
