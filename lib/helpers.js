 ...
 * @typedef { import('../index').PrintablePacket } PrintablePacket
 ...
 * @typedef { import('coap-packet').NamedOption } NamedOption
 *
 * @typedef Block
 * @prop {number} more Indicates if the `more` flag is set
...
module.exports.setOption = (packet, name, values) => {
    ...
    if (!Array.isArray(values)) {
        ...
        for (const value of values) {
            packet.options.push({ name, value })
        }
    }
}
...
/**
 *
 * @param {(Option | NamedOption)[]} options
 * @param {OptionName | string} name
 * @returns {true | null}
 */
 ...
 * @param {OptionName | string} name name of the object wanted to retrive
 ...
 *
 * @param {Option[]} options array of object, in form {name: , value}
 * @param {OptionName | string} name name of the object wanted to remove
 ...
 * @returns {Block | null} Block state object with `num`, `size`, and `more` flag.
