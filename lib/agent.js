 ...
 * @typedef { import('../index').AgentOptions } AgentOptions
...
class Agent extends events.EventEmitter {
    ...
    _init (socket) {
        ...
        /** @type {Map<number, OutgoingMessage>} */
        this._msgIdToReq = new Map()
        /** @type {Map<string, OutgoingMessage>} */
     ...
     * @param {CoapRequestParams} url The parameters for the request
     */
    request (url) {
        this._init()
        ...
        let option
        const multicastTimeout = url.multicastTimeout !== undefined ? url.multicastTimeout : 20000
